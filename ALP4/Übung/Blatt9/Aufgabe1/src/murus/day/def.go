...
// If (d, m, y) defines a day within the range of the
// implementation, x is that day. Otherwise, x is empty.
  Set (d, m, y uint) bool
...
// TODO Spec
  WriteWeek (v bool, a, Z, S uint)

// TODO Spec
  PosInMonth (v bool, n, z, s uint) (uint, uint)

// TODO Spec
  WriteMonth (v bool, n, z, s, Z, S uint)

// TODO Spec
  PrintMonth (v bool, n, z, s, Z, S uint)
